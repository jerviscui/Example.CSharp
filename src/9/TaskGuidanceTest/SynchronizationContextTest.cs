...
namespace TaskGuidanceTest
{
    partial class Program
    {
        public class SynchronizationContextTest
        {
            ...
            {
                //1
                Console.WriteLine($"GetContextTest2 {Thread.CurrentThread.ManagedThreadId.ToString()}");
            ...
            {
                //1
                Console.WriteLine($"GetContextTest {Thread.CurrentThread.ManagedThreadId.ToString()}");
                await Task.Factory.StartNew(() =>
                {
                    //7
                    Console.WriteLine($"task {Thread.CurrentThread.ManagedThreadId.ToString()}");
            ...
            {
                //ManagedThreadId 1
                Console.WriteLine($"AsyncContinuation_GetContextTest {Thread.CurrentThread.ManagedThreadId.ToString()}");
            ...
            {
                //1
                Console.WriteLine($"DirectReturn_GetContextTest {Thread.CurrentThread.ManagedThreadId.ToString()}");
            ...
            {
                //1
                Console.WriteLine($"DirectReturnAndSynchroContinue_GetContextTest {Thread.CurrentThread.ManagedThreadId.ToString()}");
