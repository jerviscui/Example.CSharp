...
namespace MapsterTest.Models
{
    public static partial class CourseMapper
    {
        ...
        public static Expression<Func<Course, CourseDto>> ProjectToDto => p12 => new CourseDto(p12.CourseId, p12.Title, p12.Credits, p12.Enrollments.Select<Enrollment, EnrollmentDto>(p13 => new EnrollmentDto(p13.EnrollmentId, p13.CourseId, p13.StudentId, p13.Grade, new CourseDto(p13.Course.CourseId, p13.Course.Title, p13.Course.Credits, null), new StudentDto(p13.Student.Id, p13.Student.LastName, p13.Student.FirstMidName, p13.Student.EnrollmentDate, null))).ToList<EnrollmentDto>());
